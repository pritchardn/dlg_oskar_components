"""
dlg_oskar_components component module.

This is the module of dlg_oskar_components containing DALiuGE data components.
...
# @param[in] param/appclass Drop Class/dlg_oskar_components.MyData/String/readonly/
